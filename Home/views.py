...
def signupuser(request):
    ...
    return render(request, 'Home/signupuser.html',{'form':form, 'profile_form':profile_form})
    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                ...
                return render(request,'Home/loginuser.html', {'form':AuthenticationForm(), 'error':'Account not Activated.'})
        else:
            messages.error(request,"Invalid Login Details!")
            return render(request,'Home/loginuser.html', {'form':AuthenticationForm(), 'error':'Invalid Login Details!'})
    else:
